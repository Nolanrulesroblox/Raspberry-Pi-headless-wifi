# A simple download for Raspberry Pi headless install with SSH
...
or
 ...
 <h1> how to find your code, Find your Country, and your code is the Second one. (IE: United States is US, Algeria is DZ) </h1>
...
```bash
 ...
 United States Minor Outlying Islands[e]	UM	UMI	581	ISO 3166-2:UM	No
